                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{url('admin/team/create')}}" class="btn btn-primary btn-sm">Tambah Data</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$val->name}}</td>
                                    <td>{{$val->position}}</td>
                                    <td class="text-center"><img src="{{asset('storage/team/'.$val->image)}}" alt="" style="width:100px;"></td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{url('admin/team/'.$val->id.'/edit')}}" class="btn btn-primary btn-xs"><i class="fa fa-pen"></i></a>
