...
<script>
    $(function () {
        ...
        az = {
            delete: function(id){
                var base="{{url('admin/testimonial')}}";
                var url = base.concat('/',id);
                var token = '{{ csrf_field() }}';
                Swal.fire({
                    title: 'Delete Data?',
                    text: "Data Testimonial akan di delete.",
                    icon: 'question',
                       ...
                       $.ajax({
                            ...
                            success: function (res) {
                                if(res == 'success'){
                                    Swal.fire({
                                        title: 'Deleted!',
                                        text: 'Data Testimonial Berhasil di Delete.',
                                        icon: 'success',
                                    })
                                    ...
                                    swal({
                                        title: 'Error!',
                                        text: 'Data Testimonial Gagal di Hapus.',
                                        icon: 'error',
                                    })
                                }
                            },
...
@endpush @section('title','Testimonial') 
@section('content')
@if ($errors->any())
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{url('admin/testimonial/create')}}" class="btn btn-primary btn-sm">Tambah Data</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{url('admin/testimonial/'.$val->id.'/edit')}}" class="btn btn-primary btn-xs"><i class="fa fa-pen"></i></a>
