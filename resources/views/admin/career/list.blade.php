                       ...
                       $.ajax({
                            ...
                            success: function (res) {
                                if(res == 'success'){
                                    Swal.fire({
                                        title: 'Deleted!',
                                        text: 'Data career Berhasil di Delete.',
                                        icon: 'success',
                                    })
                                    window.location.href = "{{url('admin/career')}}/";
                                }else{
                                    swal({
                                        title: 'Error!',
                                        text: 'Data career Gagal di Hapus.',
                                        icon: 'error',
                                    })
                                }
                            },
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{url('admin/career/create')}}" class="btn btn-primary btn-sm">Tambah Data</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{url('admin/career/'.$val->id.'/edit')}}" class="btn btn-primary btn-xs"><i class="fa fa-pen"></i></a>
