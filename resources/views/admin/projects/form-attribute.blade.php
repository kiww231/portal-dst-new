...
@endpush
@section('title','Projects Attribute') 
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Data Projects Attribute</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    @if ($errors->any())
                    ...
                    @endif
                    <form action="{{url('admin/projects-attribute', $result->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="card-body">
                            <div class="row">
