                       ...
                       $.ajax({
                            ...
                            success: function (res) {
                                if(res == 'success'){
                                    Swal.fire({
                                        title: 'Deleted!',
                                        text: 'Data Projects Berhasil di Delete.',
                                        icon: 'success',
                                    })
                                    ...
                                    swal({
                                        title: 'Error!',
                                        text: 'Data Projects Gagal di Hapus.',
                                        icon: 'error',
                                    })
                                }
                            },
...
@endpush @section('title','Projects') 
@section('content')
@if ($errors->any())
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{url('admin/projects/create')}}" class="btn btn-primary btn-sm">Tambah Data</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{url('admin/projects/'.$val->id.'/edit')}}" class="btn btn-primary btn-xs"><i class="fa fa-pen"></i></a>
