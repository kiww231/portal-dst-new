                ...
                <div class="card card-default">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{url('admin/brand/')}}" class="btn btn-primary btn-sm">Kembali</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form action="{{@$result ? route('brand.update', $result->id) : route('brand.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
